...
ENV ZOO_TICK_TIME="2000" \
    ...
    ZOO_INIT_LIMIT="5" \
    ZOO_SYNC_LIMIT="2" \
    ZOO_SERVERS="1@zoo-stset-0.zoo-stset.kube-tr.svc.cluster.local:2888:3888,2@zoo-stset-1.zoo-stset.kube-tr.svc.cluster.local:2888:3888,3@zoo-stset-2.zoo-stset.kube-tr.svc.cluster.local:2888:3888"
